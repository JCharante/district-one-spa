<template>
    <div class="column col-xs-12 col-sm-6 q-pa-lg items-center" style="width: 450px; max-width: 100%; margin: auto; margin-top: 0;">
        ...
        <q-list bordered separator style="">
            <q-item-label header>Events ranked by favorites</q-item-label>
            <EventShortInfo
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapGetters(['getShortEventInfo']),
            filteredListOfEvents() {
                const self = this;
                const eventsSortedByLikes = this.getShortEventInfo.slice().sort((a, b) => ((a.likes > b.likes) ? -1 : 1));
